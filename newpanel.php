        ...
        <div class="form-section-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
             ...
             <div class="mb-3">
    <label class="form-label">Panel Title / Role</label>
    <select name="panel_title" class="form-select" required>
        <option value="">— Select panel role —</option>
        <option value="EE">EE — External Examiner</option>
        <option value="PA">PA — Programme Assessor</option>
        <option value="IAP">IAP — Industry Advisory Panel</option>
        <option value="IA">IA — Industry Advisor</option>
        <option value="EA">EA — External Advisor</option>
    </select>
</div>
          </div>
...
<div class="modal fade" id="previewModal" tabindex="-1">
 ...
 <div class="preview-row">
    <div class="p-key">Panel Role</div>
    <div class="p-val" id="pTitle"></div>
</div>
...
function showPreview() {
    ...
    document.getElementById('pDate').textContent = raw
        ...
        : '—';
 const titleSelect = document.querySelector('select[name="panel_title"]');
